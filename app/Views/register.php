    ...
    <div class="position-absolute form">
        <h1 class="text-dark">Register Employee</h1>
            <form class="row g-4" style="max-height: 600px" method="post" action="/register">
                <div class="row">
                    <div class="col-12">
                        <label for="staffid" class="text-dark form-label">Staff ID</label>
                        <input type="text" class="form-control" id="staffid" placeholder="Staff ID">
                    </div>
                    <div class="col-md-6">
                        <label for="fname" class=" text-dark mt-2 form-label">First Name</label>
                        <input type="text" class="form-control" id="fname" placeholder="First Name">
                    </div>
                    <div class="col-md-6">
                        <label for="lname" class="text-dark mt-2 form-label">Last Name</label>
                        <input type="text" class="form-control" id="lname" placeholder="Last Name">
                    </div>
                    <div class="col-md-6 pd-telephone-input">
                        <label for="tel" class="text-dark mt-2 form-label">Phone Number</label>
                        <input type="tel" class="form-control" id="tel" placeholder="Phone Number">
                    </div>
                    <div class="col-md-6">
                        <label for="email" class="text-dark mt-2 form-label">Email</label>
                    ...
                    <div class="col-md-6">
                        <label for="usertype" class="text-dark mt-2 form-label">Employee type</label>
                        <select id="department" class="form-select">
                ...
                <div class="row">
                    <div class="col-12 ml-5 col-sm8- offset-sm-2 offset-md-4 pt-4 from-wrapper">
                        <button type="submit" class="btn mb-4 button">Register employee</button>
                    </div>
                </div>
            </form>
    </div>
